    ...
    <form action="" method="POST">
        <ul>
            <li class="form-controlss">
                <label for="mkn">Nama Minuman</label>
                <input type="text" name="mnm" id="mnm" class="form-control" required oninvalid="this.setCustomValidity('woyyyyyy disii sekkk')" oninput="setCustomValidity('')">
            </li>
            <li>
